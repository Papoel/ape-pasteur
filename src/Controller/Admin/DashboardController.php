...
class DashboardController extends AbstractDashboardController
{
    ...
    public function index(): Response
    {
        $this->denyAccessUnlessGranted(
            ...
            Désolé, votre rôle ne vous donne pas accès a cette section.'
        );
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::section('Articles', 'fas fa-newspaper')
            ->setCssClass('bold text-success h6');

        yield MenuItem::subMenu('Action', 'fas fa-newspaper')
            ->setSubItems([
                MenuItem::linkToCrud('Afficher Article', 'fas fa-eye', Article::class)
...
//                MenuItem::linkToCrud('Détail Article', 'fas fa-info', Article::class)->setAction(Crud::PAGE_DETAIL),
        ...
        yield MenuItem::section('Catégories', 'fas fa-tags')
            ->setCssClass('bold text-success h6');

        yield MenuItem::subMenu('Action', 'fas fa-tags')
            ->setSubItems([
                MenuItem::linkToCrud('Afficher Catégorie', 'fas fa-eye', Category::class)
                    ->setAction(Crud::PAGE_INDEX),

                MenuItem::linkToCrud('Ajouter Catégorie', 'fas fa-plus', Category::class)
                    ->setAction(Crud::PAGE_NEW),
//                MenuItem::linkToCrud('Détail Catégorie', 'fas fa-info', Category::class)->setAction(Crud::PAGE_DETAIL),
            ]);

        yield MenuItem::section('Utilisateurs', 'fas fa-users')
            ->setCssClass('bold text-success h6');

        yield MenuItem::subMenu('Action', 'fas fa-users')
            ->setSubItems([
                MenuItem::linkToCrud('Afficher Utilisateur', 'fas fa-eye', User::class)
                    ->setAction(Crud::PAGE_INDEX),
